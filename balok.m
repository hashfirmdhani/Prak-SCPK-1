...
%BALOK MATLAB code file for balok.fig
...
%
%      BALOK('Property','Value',...) creates a new BALOK using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to balok_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      BALOK('CALLBACK') and BALOK('CALLBACK',hObject,...) call the
%      local function named CALLBACK in BALOK.M with the given input
%      arguments.
%
...
% Last Modified by GUIDE v2.5 06-Apr-2021 23:23:41
...
function jawaban1_Callback(hObject, eventdata, handles)
% hObject    handle to jawaban1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of jawaban1 as text
%        str2double(get(hObject,'String')) returns contents of jawaban1 as a double


% --- Executes during object creation, after setting all properties.
function jawaban1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to jawaban1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
hitung = 2*((panjang*lebar)+(panjang*tinggi)+(lebar*tinggi));
hasil = num2str(hitung);
set(handles.jawaban1,'string',(hasil));
...
function jawaban2_Callback(hObject, eventdata, handles)
% hObject    handle to jawaban2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of jawaban2 as text
%        str2double(get(hObject,'String')) returns contents of jawaban2 as a double


% --- Executes during object creation, after setting all properties.
function jawaban2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to jawaban2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
